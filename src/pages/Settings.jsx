  ...
  return (
    <div className="max-w-7xl mx-auto space-y-10">
      <header>
        ...
        <p className="text-slate-500 text-sm mt-2 font-medium">Configure your tactical environment and operative profile.</p>
      </header>
...
function AccessDenied() {
  return (
    <div className="h-full flex flex-col items-center justify-center text-center space-y-4 py-20">
      ...
      <h3 className="text-xl font-black uppercase tracking-widest text-slate-900">Access Restricted</h3>
      <p className="text-slate-500 text-xs font-medium max-w-xs">Your current clearance level does not permit access to these tactical configurations.</p>
    </div>
  );
}
